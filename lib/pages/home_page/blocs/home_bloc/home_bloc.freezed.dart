...
mixin _$HomeEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(bool refresh) getData,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(bool refresh)? getData,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$GetDataImpl implements _GetData {
  const _$GetDataImpl({this.refresh = false});
  ...
  @override
  String toString() {
    return 'HomeEvent.getData(refresh: $refresh)';
  }
...
abstract class _GetData implements HomeEvent {
  const factory _GetData({final bool refresh}) = _$GetDataImpl;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({HomeStatus status, List<Task> taskList, String error});
}
...
class _$HomeStateImpl implements _HomeState {
  ...
  @override
  String toString() {
    return 'HomeState(status: $status, taskList: $taskList, error: $error)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, status,
      const DeepCollectionEquality().hash(_taskList), error);
